...
const QUALITY_VERSION = 'v10.11-frozen-set-adaptive-v6';
const CALIBRATION_VERSION = 'style-v2';
const BUILD_ENGINE_VERSION = 'v10.11-frozen-set-build-v6';
const QUESTION_ENGINE_VERSION = 'v10.11-frozen-set-v6';
  ...
  return {
    ...
    verification: {
      ...
      models: {
        ...
        solverA: 'not-used:frozen-set-v6',
        solverB: 'not-used:frozen-set-v6',
        solverC: 'not-used:frozen-set-v6',
      ...
      blindDemand: {
        ...
        observedLevel: q.level,
        shortcut: 'none',
        shortcutReason: 'v10.11 FROZEN v6 자체검수 및 난도 증명 게이트를 통과함',
...
async function startFrozenSetGeneration(assets: Awaited<ReturnType<typeof frozenSetAssets>>, targets: BuildTarget[]) {
  return openAiStartBackground({
    model: GPT_MODELS.generator,
    schemaName: 'frozen_set_questions_v6',
    ...
    async ctx => {
      ...
      try {
        return await withKeyedLock(`passage:${passageId}`, async () => {
          ...
          if (
            b.trial !== true &&
            QUESTION_ENGINE_VERSION === 'v10.11-frozen-set-v6'
          )
